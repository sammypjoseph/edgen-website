...
(function () {
  ...
  if (!window.d3 || !window.topojson) {
    setFallback(
      ...
      "Please confirm the D3 and topojson script tags were added above edgen-ami-map.js near the bottom of index.html."
    );
    return;
  }
  ...
  Promise.all([
    ...
    setFallback(
      "Eligibility map could not load.",
      "Please confirm edgen-ami-2026.json is uploaded and the D3/topojson scripts are present in index.html."
    );
  });
})();
